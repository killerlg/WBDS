...
public class ProductController {
    ...
    public ModelAndView saveProduct(@ModelAttribute ProductForm productForm) {
        ...
        try {
            FileCopyUtils.copy(productForm.getImage().getBytes(), new File("C:\\Users\\Q Anh DD\\OneDrive - Hanoi University of Science and Technology\\Desktop\\Git\\WBDS\\Bai4Thuchanh3\\src\\main\\webapp\\image\\" + fileName));
